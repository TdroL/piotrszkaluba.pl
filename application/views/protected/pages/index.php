<div class="columns_1">
	<div class="column">
		<?php echo html::anchor('admin/pages/create', __('Create page'), array('class' => 'add')); ?>
		<br />
		<br />
		<div>
			<table class="table_1">
...
<?php if(count($pages)) foreach($pages as $v): ?>
					<tr class="<?php echo text::alternate ('even', 'odd') ?>">
						...
						<td class="imp_blue">
							<a href="<?php echo url::site('admin/pages/update.'.$v->id) ?>"><?php echo html::image('media/admin/img/edit.png', array('alt' => 'Edytuj', 'title' => __('Update'))) ?></a>
							<a href="<?php echo url::site('admin/pages/delete.'.$v->id) ?>"><?php echo html::image('media/admin/img/erese.png', array('alt' => 'Usuń', 'title' => __('Delete'))) ?></a>
						</td>
					</tr>
<?php endforeach ?>
				</tbody>
