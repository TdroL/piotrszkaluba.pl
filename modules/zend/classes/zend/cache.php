...
abstract class Zend_Cache
{
    ...
    public static function _makeBackend($backend, $backendOptions, $customBackendNaming = false, $autoload = false)
    {
        ...
        if (in_array($backend, Zend_Cache::$standardBackends)) {
            ...
            require_once './modules/zend/classes/' . str_replace('_', DIRECTORY_SEPARATOR, strtolower($backendClass)) . '.php';
        } else {
            ...
            if (!$autoload) {
                $file = './modules/zend/classes/'.str_replace('_', DIRECTORY_SEPARATOR, strtolower($backendClass)) . '.php';
    ...
    public static function _makeFrontend($frontend, $frontendOptions = array(), $customFrontendNaming = false, $autoload = false)
    {
        ...
        if (in_array($frontend, self::$standardFrontends)) {
            ...
            // security controls are explicit
            require_once 'modules/zend/classes/'.str_replace('_', DIRECTORY_SEPARATOR, strtolower($frontendClass)) . '.php';
        } else {
            ...
            if (!$autoload) {
                $file = 'modules/zend/classes/'.str_replace('_', DIRECTORY_SEPARATOR, strtolower($frontendClass)) . '.php';
                if (!(self::_isReadable($file))) {
                    self::throwException("file $file not found in include_path");
                }
                require_once $file;
    ...
    public static function throwException($msg)
    {
        ...
        require_once 'modules/zend/classes/zend/cache/exception.php';
